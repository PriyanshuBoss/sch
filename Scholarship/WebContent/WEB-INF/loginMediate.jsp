...
<%
session.setAttribute("lgn",(String)session.getAttribute("Login"));
%>
<table >
<tr>
<td style="vertical-align:top">
<br><br>
<button onclick="location.href='loginDetails.jsp'" class="mybutton" type="button" style="width: 200px; height: 37px;">
     APPLICATION FORM</button>
<br><br><br><br>
<button onclick='<jsp:forward page="printLogin.jsp"></jsp:forward>' class="mybutton" type="button" style="width: 200px; height: 37px;">
     PRINT FORM</button>
 <br><br><br><br>
